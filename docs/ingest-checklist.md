...
3. **Vision path** — photos: extract JSON using `references/vision-extract-prompt.md` → `ingest_image.py --json ...`. Multi-photo: one JSON per photo, pass all to `--json` for merge.
